...
{
    public class ddColumn : IEquatable<ddColumn>
    {
        public ddColumn(string name, int type, string typeName, int precision = 0, int scale = 0, int maxSymb = 0, bool isNullable = true)
        {
            Name = name;
            Type = type;
        ...
        public bool Equals(ddColumn other)
        {
            if (other == null)
                return false;
